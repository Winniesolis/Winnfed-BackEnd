...
<head>
    ...
    <title>Winnfed | Ver Usuario</title>
            ...
            <div class="container-fluid content-client">
                <div class="row header-client">
                    ...
                    <div class="view-client col-xl-6 ">
                        <a href="proveedor.php"><i class="fas fa-eye"></i>Agregar Usuario</a>
                    </div>
                    <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 mx-auto">
                        <table class="table Tcliente table-responsive">
                            ...
                            <tr  class="text-center">
                                ...
                                <?php
                                    $query = mysqli_query($conexion, "SELECT * FROM usuarios INNER JOIN estado ON usuarios.estadoUS = estado.idestado INNER JOIN tipus ON usuarios.tipUS = tipus.idTipoUsuario ");
                                    $result = mysqli_num_rows($query);
                                    if($result > 0){
                                        while($Mclient3 = mysqli_fetch_array($query)){
                                    ?>
                                    <tr class="text-center">
                                        <td><?php echo $Mclient3['idusuarios'] ?></td>
                                        <td><?php echo $Mclient3['nombresUS'] ?></td>
                                        <td><?php echo $Mclient3['apellidosUS'] ?></td>
                                        <td><?php echo $Mclient3['estadoUS'] ?></td>
                                        <td><?php echo $Mclient3['telefonoUS'] ?></td>
                                        <td><?php echo $Mclient3['emailUS'] ?></td>
                                        <td><?php echo $Mclient3['usuarioUS'] ?></td>
                                        <td><?php echo $Mclient3['TipUS'] ?></td>
