...
<head>
    ...
    <title>Winnfed | Ver Proveedores</title>
            ...
            <div class="container-fluid content-client">
                <div class="row header-client">
                    ...
                    <div class="view-client col-xl-6 ">
                        <a href="proveedor.php"><i class="fas fa-eye"></i>Agregar Proveedor</a>
                    </div>
                    <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 mx-auto">
                        <table class="table Tcliente table-responsive">
                            <thead class="thead-dark">
                                ...
                                <?php
                                    $query = mysqli_query($conexion, "SELECT * FROM proveedores INNER JOIN estado WHERE proveedores.idestado = estado.idestado");
                                    $result = mysqli_num_rows($query);
                                    if($result > 0){
                                        while($Mclient2 = mysqli_fetch_array($query)){
                                    ?>
                                    <tr class="text-center">
                                        <td><?php echo $Mclient2['idproveedor'] ?></td>
                                        <td><?php echo $Mclient2['nombreEP'] ?></td>
                                        <td><?php echo $Mclient2['rfcEP'] ?></td>
                                        <td><?php echo $Mclient2['correoEP'] ?></td>
                                        <td><?php echo $Mclient2['telefonoEP'] ?></td>
