...
<head>
    ...
    <title>Winnfed | Documentación</title>
                    ...
                    <div class="container mt-150">
                        <div class="row">
                            <div class="row col-xl-8 mx-auto">
                                <div class="col-xl-6">
                                    <a href="cotizaciones.php" class="btn btn_cot">Cotizaciones</a>
                                </div>
                                <div class="col-xl-6">
                                    <a href="notas.php" class="btn btn_not">Notas</a>
                                </div>
                                <div class="col-xl-6 mx-auto">
                                    <a href="listaprecios.php" class="btn btn_prec">Lista de precios</a>
                                </div>
                            </div>
                        </div>
                    </div>
